...
public class ConnectionAPIOrderInfo extends ConnectionAPI {
    OrderInfo mOrderInfo;

    public ConnectionAPIOrderInfo(OrderInfo mNewOrderInfo, String apiAdress)
    {
        if (checknetwork(mNewOrderInfo))
        {
            mOrderInfo = mNewOrderInfo;
            APIAdress = apiAdress;
        }
    }
        ...
        if (response != null) {
            ...
            try {
                ...
                for (int cptObjects = 0; cptObjects < jsonRoot.length(); cptObjects++) {
                    ...
                    String idWareHouse = object.getString("productName");
                    mOrderInfo.SetOrderInfoText(idWareHouse);
                }
